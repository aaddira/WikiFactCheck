...
# Default to the authenticated account. Most SMTP providers (Gmail included)
# refuse to send as an address you haven't verified, so falling back to
# noreply@wikifactcheck.com produced mail that was rewritten or rejected.
app.config["MAIL_DEFAULT_SENDER"] = (
    os.getenv("MAIL_DEFAULT_SENDER")
    or os.getenv("MAIL_USERNAME")
    or "noreply@wikifactcheck.com"
)
